...
export class NoiseProtocol {
    ...
    // HKDF-SHA256
    private hkdf(chainingKey: Uint8Array, inputKeyMaterial: Uint8Array): [Uint8Array, Uint8Array, Uint8Array] {
        const tempKey = _unstable_crypto_kdf_hkdf_sha256_extract(inputKeyMaterial, chainingKey);
