...
export const BLEProvider: React.FC<BLEProviderProps> = ({ children }) => {
                        ...
                        (async () => {
                            try {
                                ...
                                if (connected) {
                                    ...
                                    setConnectedDeviceIds((prev) => [...new Set([...prev, device.id])]);
    ...
    const startAdvertising = useCallback(async () => {
        ...
        try {
            ...
            // Get identity (source of truth for nickname)
            const identity = identityStateManager.getIdentity();
            const nickname = identity?.nickname || await SecureStore.getItemAsync("nickname");
