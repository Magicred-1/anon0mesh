            ...
            <View style={S.confirmBody}>
              ...
              <View style={S.btnRow}>
                ...
                <Pressable onPress={confirmRotate} style={[S.rotateBtn, { backgroundColor: colors.error }]}>
                  ...
                  <Text style={[S.rotateBtnText, { color: colors.textPrimary }]}>ROTATE</Text>
                </Pressable>
              </View>
            </View>
          )}
...
const S = StyleSheet.create({
  ...
  rotateBtn:    { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, padding: 13, borderRadius: radii.md },
  rotateBtnText:{ fontFamily: fontFamily.sansMd, fontSize: fontSize.xs, fontWeight: '600', letterSpacing: 2.5, textTransform: 'uppercase' },
  ...
  newAddr:      { fontFamily: fontFamily.sansMd, fontSize: fontSize.xs, letterSpacing: 1 },
